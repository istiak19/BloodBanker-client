    ...
    const faqData = [
        {
            ...
            a: "Anyone aged 18-65 years, weighing over 50kg, and in good health can donate."
        },
        {
            q: "🩸 How often can I donate?",
            a: "Whole blood donation is recommended once every 3 months."
        },
        {
            q: "🩸 Is blood donation safe?",
            a: "Yes, it’s completely safe. New sterile equipment is used for each donor."
        },
        {
            q: "🩸 What should I eat before donating?",
            a: "Have a light meal and drink plenty of water. Avoid oily or fatty foods before donation."
        },
        {
            q: "🩸 How long does the donation process take?",
            a: "The entire process takes about 30–45 minutes, while the actual blood collection lasts only 8–10 minutes."
        },
        {
            q: "🩸 Can I donate blood if I am taking medication?",
            a: "It depends on the medication. Common medicines like antibiotics may require you to wait. Always consult the donation center staff."
        },
    ];

    return (
        <section className={`py-8 px-4 container mx-auto ${isDarkMode ? 'bg-gray-950 text-gray-100' : 'bg-gradient-to-r from-red-50 via-red-100 to-red-200 text-gray-900'}`}>
            <Helmet>
